...
def main():
    ...
    goal_pose.append(navigator.getPoseStamped([-2.3, 0.08], TurtleBot4Directions.EAST))
    goal_pose.append(navigator.getPoseStamped([-2.3, -1.8], TurtleBot4Directions.NORTH))
    goal_pose.append(navigator.getPoseStamped([-0., -1.9], TurtleBot4Directions.NORTH))
